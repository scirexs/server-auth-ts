/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d7b14f64286303f0ebb5a7096c7b2fb)
// Runtime types generated with workerd@1.20250709.0 2024-07-12
declare namespace Cloudflare {
    interface Env {
        RESEND_API_KEY: string;
        TURNSTILE_SECRET_KEY: string;
		SIGNUP_VERIFY: DurableObjectNamespace<import("./src/index").DOSignupVerify>;
		LOGIN_REQUEST: DurableObjectNamespace<import("./src/index").DOLoginRequest>;
		USER_SESSION: DurableObjectNamespace<import("./src/index").DOUserSession>;
		RATE_LIMIT: DurableObjectNamespace<import("./src/index").DORateLimit>;
		D1: D1Database;
	}
}
